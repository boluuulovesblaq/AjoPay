    ...
    <section style={{
      ...
      <div style={{
        ...
        background: `
          ...
          radial-gradient(ellipse 30% 40% at 20% 80%, rgba(234,88,12,0.06) 0%, transparent 70%)
        `
      }} />
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <div style={{ position: 'relative', width: '320px', height: '320px' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.75rem', color: '#22c55e', fontWeight: 600, marginBottom: '1rem' }}>
                  ↑ 12% this cycle
                </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.7rem', color: 'var(--muted)', marginTop: '0.1rem' }}>2 mins ago</div>
                </div>
